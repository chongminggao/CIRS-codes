...
python CIRS-UserModel-taobao.py    --cuda 0 --epoch 10 --tau 0.01 --message "taobao tau 0.01" & # UM Taobao50 CIRS
python CIRS-UserModel-taobao.py    --cuda 0 --epoch 10 --tau 0 --message "taobao tau 0" & # UM CIRS-wo-CI
...
# Taobao, Length == 10
python CIRS-UserModel-taobao.py    --cuda 0 --epoch 10 --tau 1 --message "taobao tau 1" & # UM CIRS
python CIRS-UserModel-taobao.py    --cuda 0 --epoch 10 --tau 0 --message "taobao tau 0" & # UM CIRS-wo-CI
...
#
## Taobao, Length == 50
#python CIRS-RL-taobao.py --cuda 3  --max_turn 50 --epoch 100 --tau 10 --leave_threshold 3 --num_leave_compute 5 --read_message "taobao tau 0.01" --message "T_CIRS_len50" &
#python CIRS-RL-taobao.py --cuda 3  --max_turn 50 --epoch 100 --tau 0  --leave_threshold 3 --num_leave_compute 5 --read_message "taobao tau 0" --message "T_CIRSwoCI_len50" &
#
## Taobao, Length == 10
#python CIRS-RL-taobao.py --cuda 3  --max_turn 10 --epoch 200 --tau 0.1 --leave_threshold 1 --num_leave_compute 5 --read_message "taobao tau 1" --message "T_CIRS_len10" &
#python CIRS-RL-taobao.py --cuda 3  --max_turn 10 --epoch 200 --tau 0 --leave_threshold 1 --num_leave_compute 5 --read_message "taobao tau 0" --message "T_CIRSwoCI_len10" &
#
#
## KuaiEnv, Length == 30
