...
#
#
#python CIRS-RL-kuaishou.py  --cuda 0 --leave_threshold 0 --num_leave_compute 1 --tau 10  --gamma_exposure 10  --max_turn 30 --is_ab --epoch 1000 --read_message "Pair11"  --message "CIRS-leave1"  &
#python CIRS-RL-kuaishou.py  --cuda 1 --leave_threshold 0 --num_leave_compute 2 --tau 10  --gamma_exposure 10  --max_turn 30 --is_ab --epoch 1000 --read_message "Pair11"  --message "CIRS-leave2"  &
#python CIRS-RL-kuaishou.py  --cuda 2 --leave_threshold 0 --num_leave_compute 3 --tau 10  --gamma_exposure 10  --max_turn 30 --is_ab --epoch 1000 --read_message "Pair11"  --message "CIRS-leave3"  &
#python CIRS-RL-kuaishou.py  --cuda 3 --leave_threshold 0 --num_leave_compute 4 --tau 10  --gamma_exposure 10  --max_turn 30 --is_ab --epoch 1000 --read_message "Pair11"  --message "CIRS-leave4"  &
#python CIRS-RL-kuaishou.py  --cuda 4 --leave_threshold 0 --num_leave_compute 5 --tau 10  --gamma_exposure 10  --max_turn 30 --is_ab --epoch 1000 --read_message "Pair11"  --message "CIRS-leave5"  &
#
#python CIRS-RL-kuaishou.py --cuda 5  --leave_threshold 0 --num_leave_compute 1 --tau 0   --max_turn 30 --no_ab --epoch 1000 --read_message "Pair1" --message "CIRS w_o CI-leave1" &
#python CIRS-RL-kuaishou.py --cuda 7  --leave_threshold 0 --num_leave_compute 2 --tau 0   --max_turn 30 --no_ab --epoch 1000 --read_message "Pair1" --message "CIRS w_o CI-leave2" &
#python CIRS-RL-kuaishou.py --cuda 0  --leave_threshold 0 --num_leave_compute 3 --tau 0   --max_turn 30 --no_ab --epoch 1000 --read_message "Pair1" --message "CIRS w_o CI-leave3" &
#python CIRS-RL-kuaishou.py --cuda 1  --leave_threshold 0 --num_leave_compute 4 --tau 0   --max_turn 30 --no_ab --epoch 1000 --read_message "Pair1" --message "CIRS w_o CI-leave4" &
#python CIRS-RL-kuaishou.py --cuda 2  --leave_threshold 0 --num_leave_compute 5 --tau 0   --max_turn 30 --no_ab --epoch 1000 --read_message "Pair1" --message "CIRS w_o CI-leave5" &
#
#
### For VirtualTaobao:
